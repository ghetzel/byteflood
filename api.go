...
func (self *API) Serve() error {
	...
	router.Get(`/api/shares/:id/synclist`, self.handleShareSynclist)
	router.Get(`/api/shares/:id/synclist/:file`, self.handleShareSynclist)
...
func (self *API) GetPeerRequestHandler() http.Handler {
	...
	router.Get(`/shares/:id/synclist`, self.handleShareSynclist)
	router.Get(`/shares/:id/synclist/:file`, self.handleShareSynclist)
